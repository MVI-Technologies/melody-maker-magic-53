...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-vCT1NryL.mjs");
...
const manifest = {
  "7f92d135aa3763ddd5bf6d4d9f84832b6b591cbaa35dcc4048b4b1beed8e7bf3": {
    ...
    importer: () => import("./orders.functions-Bcr4Y_cj.mjs")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-Dxp-gmJc.mjs").then((n) => n.r),
